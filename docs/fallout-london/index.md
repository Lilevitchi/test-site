...
<div class="hub-wrapper">
  ...
  <div class="hub-bg" style="background-image: url('../assets/london.jpg');"></div>
  ...
  <div id="hubBurgerMenu" class="hub-burger-menu">
   ...
   <a href="../fallout4/" class="burger-item">Fallout 4</a>
      <a href="../fallout-london/" class="burger-item active-game">Fallout London</a>
  ...
  <img src="../assets/lile-bot-london.png"
             class="hub-bot"
             alt="Robot Fallout London">
 ...
 <div class="selection-zone">
  ...
  <div class="game-grid">
   ...
   <a href="../fallout-london/" class="game-card active-game">
