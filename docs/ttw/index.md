...
<div class="hub-wrapper">
  ...
  <div class="hub-bg" style="background-image: url('../assets/ttw.jpg');"></div>
  ...
  <div id="hubBurgerMenu" class="hub-burger-menu">
   ...
   <a href="../fallout4/" class="burger-item">Fallout 4</a>
      ...
      <a href="../ttw/" class="burger-item active-game">TTW</a>
 ...
 <div class="display-zone">
  ...
  <div class="bot-bubble">
   ...
   <img src="../assets/lile-bot-ttw.png"
             class="hub-bot"
             alt="Robot TTW">
 ...
 <div class="selection-zone">
  ...
  <a href="../ttw/" class="game-card active-game">
